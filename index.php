...
<html lang="en" dir="ltr">
  <head>
    ...
    <div class="site-navbar-wrap">
      ...
      <div class="site-navbar site-navbar-target js-sticky-header">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-2">
              <h1 class="my-0 site-logo"><a href="index.html">No name</a></h1>
            </div>
            <div class="col-10">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/xxx.jpg);" data-aos="fade" data-stellar-background-ratio="0.5"id="home-section">
      <div class="container">
