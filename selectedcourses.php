          ...
          <div class="col-md-12">
            <section class="task-panel tasks-widget">
              <div class="panel-heading">
                <div class="pull-left">
                  <h5><i class="fa fa-tasks"></i>Selected Courses</h5>
                </div>
                <br>
              </div>
                  ...
                  <ul id="sortable" class="task-list">
                    ...
                    <li class="list-primary">
                      ...
                      <div class="task-title">
                        <span class="task-title-sp"><?= $nam['name']?></span>
              ...
              <?php endwhile;?>
                ...
                <div class=" add-task-row">
                  <a class="btn btn-success btn-sm pull-left" href="courses.php">Add Course</a>
                </div>
              </div>
            </section>
          </div>
