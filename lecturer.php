        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="custom-bar-chart">
              ...
              <div class="bar">
                <div class="title">COSC 101</div>
                <div class="value tooltips" data-original-title="8.500" data-toggle="tooltip" data-placement="top">85%</div>

              </div>
              <div class="bar ">
                <div class="title">COSC 102</div>
            ...
            <div class="row mt">
              ...
              <div class="col-md-4 col-sm-4 mb">
                <div class="darkblue-panel pn">
                  ...
                  <footer>
                    <div class="pull-left">
                      <h5><i class="fa fa-hdd-o"></i> Continous Assessment</h5>
                    </div>
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="#">Paul Rudd</a> Came online.<br/>
                </p>
              </div>
            </div>
            <!-- USERS ONLINE SECTION -->
            <h4 class="centered mt">Lecturers Online</h4>
            <!-- First Member -->
            <div class="desc">
              <div class="thumb">
